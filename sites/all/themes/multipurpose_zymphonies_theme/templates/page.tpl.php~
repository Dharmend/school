...
<div id="header_wrapper">
  <header id="header" class="clearfix">
    ...
    <div class="top_left">
      <?php if ($logo): ?>
        <div id="logo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><img src="<?php print $logo; ?>"/></a>
	</div>
	<h1 id="site-title-front"><div id="site-description11">R.S Memorial Olympian Public School</div></h1>
      <?php endif; ?>
      <h1 id="site-title">
...
<div id="footer">
  ...
  <div class="credits">
    <?php print t('Design by'); ?><a href="http://webscreativ.com/"> webscreative</a>
  </div>
